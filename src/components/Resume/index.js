...
import myResume from '../../assets/pdf/Robb_resume.pdf';
            ...
            <div className="w75 bg-dark section-container flex-row justify-center">
                <div className="side-container">
                    <div className="resume-block">
                        <h2 className="mb-1">Robb <span className="text-primary">Burson</span></h2>
                        <h4>Developer</h4>
                    ...
                    <div className="resume-block">
                        <h5>Skills</h5>
                        Node.js, Express.js, React, MongoDB, Mongoose, MySQL, Sequelize, JavaScript, JQuery, HTML, CSS, Bootstrap, REST API, Git
                    </div>
                    <div className="resume-block">
                        <h5>Education</h5>
                        <ul className="resume-list">
                            <li>Full-stack Coding Boot Camp Certificate</li>
                            <li>Associates of English</li>
                        </ul>
                    </div>
                </div>
